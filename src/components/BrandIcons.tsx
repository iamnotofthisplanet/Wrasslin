/* Minimal monochrome brand glyphs (currentColor). lucide-react no longer
   ships brand logos, so we render compact SVG paths ourselves. */
...
export const brandIcon: Record<Social["platform"], (p: IconProps) => React.ReactElement> = {
